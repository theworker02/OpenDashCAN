# Transfer manifest â€” From PyPI Ã¢â‚¬â€ full desktop (CLI + Qt + python-can)

## Schedule A â€” Included (typical)

1. Git repository `theworker02/OpenDashCAN` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for From PyPI Ã¢â‚¬â€ full desktop (CLI + Qt + python-can)
