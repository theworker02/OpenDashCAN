...
<p align="center">
  <strong>Installable desktop program (CLI + Qt) for listen-only OBD/CAN sniff, decode, cluster-gap research, and Honda Civic8Ã¢â€ â€™Civic10 adaptation documentation.</strong><br/>
...
> **HondaÃ‚Â®, the Honda logo, and related marks are trademarks and/or copyrighted works of Honda Motor Co., Ltd. All rights reserved.**  
...
**OpenDashCAN Desktop** stays on your PC. It reads vehicle CAN somehow (USB adapter, listen-only Pi recorder, or offline log), decodes **registered** layouts, and surfaces VehicleState, ID rates, PhaseÃ¢â‚¬â€˜4 cluster gaps, adaptation plans, wiring checklists, and research docs.
...
Reference adaptation: **2009 Civic (8th gen, R18 auto)** Ã¢â€ â€™ **10th-gen Civic digital cluster**  
(`honda.civic.gen8.us.r18.auto` Ã¢â€ â€™ `honda.civic.gen10.cluster.digital`).

**Donor vehicle protocol (2016+ Honda)** is substantially documented from MIT [commaai/opendbc](https://github.com/commaai/opendbc) (`VEHICLE_PROTOCOL_DOCUMENTED`). That is **not** cluster RX confirmation Ã¢â‚¬â€ donor gauge requirements, timing, and gateway behavior remain incomplete until captures and bench tests exist.

**No real vehicle captures are in this repo yet** Ã¢â‚¬â€ only labeled `SYNTHETIC` fixtures for software tests.
...
| Area | What you get |
|------|----------------|
| **CLI** | `opendashcan` Ã¢â‚¬â€ listen, plan, gaps, registry, DBC index, coverage |
| **Qt desktop** | Dark automotive UI Ã¢â‚¬â€ Live, Platform, Lookup, Gaps, Adaptation, **Wiring**, Research |
| **Live listen** | Virtual / capture replay / SocketCANÃ‚Â·PCANÃ‚Â·slcan Ã¢â‚¬â€ **LISTEN ONLY Ã¢â‚¬â€ NO TRANSMIT** banner |
...
| **DBC** | Import/index from public opendbc Ã¢â‚¬â€ never invents encodings; never auto-promotes to cluster RX |
...
| **Evidence** | GitHub issue form Ã¢â‚¬â€ do not invent CAN data |
...
<p align="center">
  ...
  <em>Live tab Ã¢â‚¬â€ virtual/offline listen, ID rates, decoded signals, LISTEN ONLY banner</em>
</p>

<p align="center">
  <img src="assets/screenshots/03_cluster_gaps.png" alt="Cluster gaps" width="720"/><br/>
  <em>Cluster gaps (Phase 4) Ã¢â‚¬â€ documentation-only axes</em>
</p>

<p align="center">
  <img src="assets/screenshots/04_adaptation_plan.png" alt="Adaptation plan" width="720"/><br/>
  <em>Adaptation plan Civic8 Ã¢â€ â€™ Civic10</em>
</p>
...
<p align="center">
  ...
  <em>Wiring tab Ã¢â‚¬â€ diagrams + harness checklist</em>
</p>
...
<p align="center">
  ...
  <em>Honda-themed boot splash Ã¢â‚¬â€ glow Ã¢â€ â€™ ready (trademark notice; no official Honda assets in git)</em>
</p>
...
**PyPI:** [opendashcan](https://pypi.org/project/opendashcan/) Ã‚Â· **Release:** [v0.1.0](https://github.com/theworker02/OpenDashCAN/releases/tag/v0.1.0)
...
### Live listen (LISTEN_ONLY Ã¢â‚¬â€ no TX)
...
| Doc | Topic |
|-----|--------|
| [OBD listen tap](docs/wiring/obd_listen_tap.md) | Pins 4/5/6/14/16 Ã¢â‚¬â€ AiM / Racelogic / Pi recorder |
| [Bus roles](docs/wiring/bus_roles.md) | F-CAN / B-CAN / gateway conceptual (pin-level UNKNOWN) |
| [Swap checklist](docs/wiring/cluster_swap_checklist.md) | Power, GND, CAN, ignition, illumination, Ã¢â‚¬Â¦ |

<p align="center">
  <img src="assets/wiring/01_obd_listen_path.png" alt="OBD listen path" width="720"/><br/>
  <em>OBD Ã¢â€ â€™ adapter Ã¢â€ â€™ OpenDashCAN Desktop (LISTEN_ONLY)</em>
</p>

<p align="center">
  <img src="assets/wiring/02_dual_bus_future.png" alt="Dual-bus future" width="720"/><br/>
  <em>Conceptual dual-bus bridge Ã¢â‚¬â€ FUTURE / NO TX default</em>
</p>
...
Listen-only Raspberry Pi recorder design: [`hardware/can_recorder_rpi/README.md`](hardware/can_recorder_rpi/README.md) (`candump` Ã¢â€ â€™ copy log Ã¢â€ â€™ `opendashcan listen --capture Ã¢â‚¬Â¦` or Live tab **Play file**).

**Manufacturing (repo only Ã¢â‚¬â€ not in the Desktop app):** partner note, production BOM/AVL, open CAD (schematic/PCB/harness/OpenSCAD), assembly + ICT/FCT, factory flash, labels Ã¢â‚¬â€ see [`hardware/MANUFACTURING_INDEX.md`](hardware/MANUFACTURING_INDEX.md) and [`hardware/can_recorder_rpi/manufacturing/`](hardware/can_recorder_rpi/manufacturing/).
...
| `INFERRED` | Heuristic Ã¢â‚¬â€ needs confirmation |
| `UNKNOWN` / `REQUIRES_BENCH` | Default / needs measurement |

**Submit verified evidence** (do not invent CAN data):  
[issue form](https://github.com/theworker02/OpenDashCAN/issues/new?template=evidence_submission.yml) Ã‚Â· [guide](docs/submitting-evidence.md) Ã‚Â· [policy](docs/evidence-policy.md)
...
opendashcan/gui/      # Qt desktop (Live, gaps, wiring, splash, Ã¢â‚¬Â¦)
